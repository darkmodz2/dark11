import os # owner name me kuchh bhi change krega to pakka error aayega
import telebot
import asyncio
import logging
import random
...
def send_price_list(chat_id):
    ...
    msg = (
        ...
        "🛒 *DarkNet DDØS H@CK* 💰💰💰\n\n"
        "*PRICE LIST👇🥰😍*\n\n"
        "*FEATURES* 500 second MAX ATTACK 🚀\n\n"
        "⏳5 HOUR = ₹50 ✅\n"
        "⏳1 DAY = ₹99 ✅\n"
        "⏳2 DAYS = ₹149 ✅\n"
        "⏳3 DAYS = ₹199 ✅\n"
        ...
        "⏳30 DAYS = ₹999 ✅\n\n"
        "*BUY DM 👉 @DarkNet_AJ*\n\n"
        "*SECOND MOST POWERFUL BOT ✅✅✅*\n\n"
        "*FEATURES* 1000 Second AND 1 MATCH IN MULTIPLE ATTACK 🚀1️⃣2️⃣3️⃣4️⃣5️⃣6️⃣7️⃣8️⃣9️⃣0️⃣✅📢\n\n"
...
def process_attack(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*Attack started 💥🧨*\n"
                                          ...
                                          f"*Port:* {port}\n"
                                          f"*Time:* {time} seconds\n\n"
                                          f"*Owner 👉 {owner_username}*", parse_mode='Markdown')
    except Exception as e:
        logging.error(f"Attack error: {e}")
